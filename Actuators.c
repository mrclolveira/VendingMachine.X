...
void SetLineMotorOn(const uint8_t line, uint8_t on) {
    switch (line) {
        case 0:
            ActuatorLine0(on == false ? true : false);
            ActuatorLine1(true);
            ActuatorLine2(true);
            ActuatorLine3(true);
            ActuatorLine4(true);
        ...
        case 1:
            ActuatorLine0(true);
            ActuatorLine1(on == false ? true : false);
            ActuatorLine2(true);
            ActuatorLine3(true);
            ActuatorLine4(true);
            break;
        case 2:
            ActuatorLine0(true);
            ActuatorLine1(true);
            ActuatorLine2(on == false ? true : false);
            ActuatorLine3(true);
            ActuatorLine4(true);
            break;
        case 3:
            ...
            ActuatorLine1(true);
            ActuatorLine2(true);
            ActuatorLine3(on == false ? true : false);
            ActuatorLine4(true);
            break;
        case 4:
            ActuatorLine0(true);
            ...
            ActuatorLine2(true);
            ActuatorLine3(true);
            ActuatorLine4(on == false ? true : false);
            break;
        default:
            ActuatorLine0(true);
            ActuatorLine1(true);
